...
class ForgotPassword(BaseModel):
    """
    Payload for forgot password request. Exactly one contact method required.
    """
...
def validate_password_strength(password: str) -> List[str]:
    """
    Returns password strength validation error messages.
    """
    errors = []
...
class UserOut(BaseModel):
    """
    User response returned to the frontend.
    ...
    can_book_rides: Optional[bool] = True
    can_offer_rides: Optional[bool] = False

    created_at: datetime
    updated_at: Optional[datetime] = None

    # Authentication tokens (when returned directly after login/signup)
...
class DriverProfileUpdate(BaseModel):
    """
    Driver-specific information update.
    """
...
class DriverProfileOut(BaseModel):
    ...
    # Uses standard Enum types matching ORM models
    chattiness: Optional[ChattinessEnum] = None
    music: Optional[MusicEnum] = None
    smoking: Optional[SmokingEnum] = None
    pets: Optional[PetsEnum] = None
...
class UserProfileUpdate(BaseModel):
    """
    Payload for updating general user profile fields.
    """
...
class ProfileUpdate(BaseModel):
    """
    Unified input schema for updating both passenger and driver preferences in a single PUT request.
    License number and license expiry date are intentionally excluded here because they are processed 
    via Form data during license photo upload.
    """
    ...
    # Driver Preference fields (license_number & license_expiry_date removed)
    about_me: Optional[str] = None
    chattiness: Optional[ChattinessEnum] = None
    music: Optional[MusicEnum] = None
    smoking: Optional[SmokingEnum] = None
...
class AdminRejection(BaseModel):
    """
    Payload for admin rejection rationale.
    """
